...
function IntelligencePreview({ invoices }: { invoices: Invoice[] | undefined }) {
  ...
  const [draftTone, setDraftTone] = useState<"friendly" | "firm" | "final">("friendly");
  ...
  const draft = useQuery(api.invoiceIntelligence.draftPreview, selectedInvoice ? { invoiceId: selectedInvoice._id, asOfDate: todayDate, tone: draftTone } : "skip");
